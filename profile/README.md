...
Этот репозиторий — единый vault документации: архитектура, спецификации криптопротокола, модель угроз, anti-censorship слой (VEIL), гайды по клиентской имплементации, деплой и публичный whitepaper.
